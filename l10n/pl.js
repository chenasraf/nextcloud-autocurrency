OC.L10N.register(
    ...
    "This NextCloud app automatically fetches currency information for your Cospend projects, and fills\n\t\tthem up using the main currency as base. No more manually updating exchange rates!\n\n\t\tIt will automatically run once a day by default and use your currency names to fetch the correct\n\t\trate.\n\n\t\tInterval for fetch may be adjusted in the admin settings \"Auto Currency\" section.\n\n\t\t> **Note**: This is a companion app to [Cospend](https://apps.nextcloud.com/apps/cospend).\n\t\t>\n\t\t> Without Cospend, this app will not work." : "Ta aplikacja Nextcloud automatycznie pobiera informacje o kursach walut dla Twoich projektów Cospend i uzupełnia je,\n\t\tużywając głównej waluty jako podstawy. Koniec z ręcznym aktualizowaniem kursów!\n\n\t\tDomyślnie uruchamia się raz dziennie i używa nazw walut do pobierania odpowiednich kursów.\n\n\t\tInterwał pobierania można dostosować w ustawieniach administratora, w sekcji „Automatyczna waluta”.\n\n\t\t> **Uwaga**: Jest to aplikacja towarzysząca dla [Cospend].(https://apps.nextcloud.com/apps/cospend). \n\t\t>\n\t\t>Bez Cospend, ta aplikacja nie będzie działać.",
    ...
    "Currency conversion rate update interval" : "Interwał aktualizacji kursów walut",
    "Symbol" : "Symbol",
    "Code" : "Kod",
    "Name" : "Nazwa",
