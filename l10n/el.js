OC.L10N.register(
    ...
    "Rates last fetched:" : "Τελευταία ανάκτηση ισοτιμιών:",
    "Loading…" : "Γίνεται φόρτωση…",
    "Never" : "Ποτέ",
    "Save" : "Αποθήκευση",
    "History Retention (days)" : "Διατήρηση Ιστορικού (ημέρες)",
    "Number of days to keep currency history. Set to 0 for no limit (default: 30)" : "Αριθμός ημερών διατήρησης του ιστορικού νομισμάτων. Ορίστε σε 0 για κανένα όριο (προεπιλογή: 30)",
    ...
    "Supported fiat currencies ({count}):" : "Υποστηριζόμενα παραδοσιακά νομίσματα ({count}):",
    "Supported cryptocurrencies ({count}):" : "Υποστηριζόμενα κρυπτονομίσματα ({count}):",
    "e.g. BTC, Bitcoin" : "π.χ. BTC, Bitcoin",
    "Search" : "Αναζήτηση",
