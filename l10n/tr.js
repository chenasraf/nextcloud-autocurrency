OC.L10N.register(
    ...
    "Never" : "Yok",
    "Save" : "Kaydet",
    "History Retention (days)" : "Geçmişi tutma süresi (gün)",
    "Number of days to keep currency history. Set to 0 for no limit (default: 30)" : "Para birimi geçmişinin tutulacağı gün sayısı. Sınırsız olması için 0 olarak ayarlayın (varsayılan: 30)",
    ...
    "Supported fiat currencies ({count}):" : "Desteklenen para birimleri ({count}):",
    "Supported cryptocurrencies ({count}):" : "Desteklenen şifreli para birimleri ({count}):",
    "e.g. BTC, Bitcoin" : "BTC, Bitcoin gibi",
    "Search" : "Ara",
