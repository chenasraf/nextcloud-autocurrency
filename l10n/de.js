OC.L10N.register(
    ...
    "This NextCloud app automatically fetches currency information for your Cospend projects, and fills\nthem up using the main currency as base. No more manually updating exchange rates!\n\n\nYou can also view the history of currency rates fetched in the past, and see how they changed over time.\n\n\nIt will automatically run once a day by default and use your currency names to fetch the correct\nrate.\n\n\nInterval for fetch may be adjusted in the admin settings \"Auto Currency\" section.\n\n\n> **Note**: This is a companion app to [Cospend](https://apps.nextcloud.com/apps/cospend).\n>\n> Without Cospend, this app will not work." : "Diese NextCloud-App ruft automatisch Währungsinformationen für deine Cospend-Projekte ab und füllt sie auf Basis der Hauptwährung.Du musst Wechselkurse nicht mehr manuell aktualisieren!Du kannst auch den Verlauf der abgerufenen Wechselkurse einsehen und deren Entwicklung im Zeitverlauf verfolgen.Die App wird standardmäßig einmal täglich ausgeführt und verwendet deine Währungsnamen, um den korrekten Kurs abzurufen.Das Abrufintervall kann in den Administrationseinstellungen unter \"Automatische Währung\" angepasst werden.>**Hinweis**: Dies ist eine Begleit-App zu [Cospend](https://apps.nextcloud.com/apps/cospend).>> Ohne Cospend funktioniert diese App nicht.",
