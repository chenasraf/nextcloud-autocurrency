OC.L10N.register(
    ...
    "This NextCloud app automatically fetches currency information for your Cospend projects, and fills\n\t\tthem up using the main currency as base. No more manually updating exchange rates!\n\n\t\tIt will automatically run once a day by default and use your currency names to fetch the correct\n\t\trate.\n\n\t\tInterval for fetch may be adjusted in the admin settings \"Auto Currency\" section.\n\n\t\t> **Note**: This is a companion app to [Cospend](https://apps.nextcloud.com/apps/cospend).\n\t\t>\n\t\t> Without Cospend, this app will not work." : "Šī Nextcloud lietotne automātiski iegūst informāciju par valūtām Cospend projektos un aizpilda\n\t\tto, izmantojot galveno valūtu kā pamatu. Vairs nekādas pašrocīgas valūtas kursu atjaunināšanas!\n\n\t\tPēc noklusējuma tā automātiski izpildīsies reizi dienā un izmanto valūtu nosaukumus, lai iegūtu pareizo\n\t\tkursu.\n\n\t\tStarplaiku starp informācijas iegūšanu var pielāgot pārvaldīšanas iestatījumu sadaļā \"Automātiska valūta\".\n\n\t\t> **Piebilde**: šī ir [Cospend](https://apps.nextcloud.com/apps/cospend) palīglietotne.\n\t\t>\n\t\t> Šī lietotne nedarbosies bez Cospend.",
