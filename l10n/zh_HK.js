OC.L10N.register(
    ...
    "Number of days to keep currency history. Set to 0 for no limit (default: 30)" : "匯率歷史紀錄保留天數。設定為 0 表示無限制（預設值：30）",
    ...
    "e.g. BTC, Bitcoin" : "例如：BTC, Bitcoin",
    "Search" : "搜尋",
